...
class TestRetryManager:
    ...
    @patch("utils.smart_retry.ExceptionAnalyzer")
    ...
    @patch("utils.smart_retry.create_standard_retry_decorator")
    @patch("utils.smart_retry.ExceptionAnalyzer")
    ...
    @patch("utils.smart_retry.create_smart_retry_decorator")
    @patch("utils.smart_retry.ExceptionAnalyzer")
