...
class TestStreamingFactory:
    ...
    def test_logs_creation_message(
        ...
        assert (
            "HIGH-PERFORMANCE" in log_messages or sample_snowflake_config.database in log_messages
        )
    ...
    def test_raises_error_with_empty_pipe_name(
        ...
        config_empty_pipe = sample_snowflake_connection_config.model_copy(update={"pipe_name": ""})
