...
This page is the checklist for the test-coverage issue split. For each issue:

1. Use the matching title from the checklist above
2. Describe the module, expected tests, and acceptance criteria in the issue body
3. Add the appropriate labels
4. Assign to a team member
5. Link to the relevant PR or planning thread
...
1. Go to: https://github.com/MiguelElGallo/evsnow/issues/new
2. Use the checklist entry for the specific module
3. Describe the test scope and acceptance criteria in the issue body
4. Add the title from the checklist
5. Add labels
6. Assign developer
7. Create issue
...
- **Standards:** [Testing](../development/testing.md)
- **Issue Templates:** This guide
- **Quick Start:** [Testing](../development/testing.md)
- **Fixtures:** [`tests/conftest.py`](https://github.com/MiguelElGallo/evsnow/blob/main/tests/conftest.py)
...
**A:** Use `@pytest.mark.asyncio` and see examples in the [testing guide](../development/testing.md).
...
3. **Developers:** Read the [testing guide](../development/testing.md) before starting
