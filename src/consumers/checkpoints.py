"""
Checkpoint management for Event Hub using Snowflake storage.
...
class SnowflakeCheckpointStore(CheckpointStore):
    ...
    async def update_checkpoint(self, checkpoint: dict[str, Any], **kwargs: Any) -> None:
        """Update Snowflake-backed checkpoint from SDK callback."""
    ...
    async def list_checkpoints(
        ...
        **kwargs: Any,
        ...
        logger.info("Loaded %s checkpoints from Snowflake for SDK", len(checkpoints))
        return checkpoints
